...
> 專案開始前，AI 助理對負責人的建議原文，保留作為背景紀錄。定案的內容以 [ADR](../adr/README.md)、[AGENTS.md](../../AGENTS.md) 與[工作卡](../backlog/README.md)為準；例如文中的「私有 GitHub repo」已由 [ADR 0011](../adr/0011-license-and-distribution.md) 改為公開。

可以開始，但先別把整份規格一次交給 AI 全做。你目前有很完整的「產品／安全規格」，但還沒有真正的開發專案：原本的規格資料夾只有 Markdown、沒有 Git、原始碼、前端、CI、測試或設計稿。
